...
export const CRYSTAL_BALL_QUESTIONS: CrystalBallQuestion[] = [
  // Champions
  { id: 'champ-most-picked', category: 'champions', question: 'For Play-ins: which champion will be picked the most?', points: 50 },
  ...
  // Players
  { id: 'player-highest-kda', category: 'players', question: 'For Play-ins: which pro will have the highest KDA?', points: 50 },
  ...
  // Teams
  { id: 'team-shortest-game', category: 'teams', question: 'For Play-ins: which team will win the shortest game (duration)?', points: 100 },
  ...
  // Other
  { id: 'other-highest-kills', category: 'other', question: 'What will be the highest number of kills in a single game?', points: 50 },
